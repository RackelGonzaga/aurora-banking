...
public class CartaoCredito extends Cartao {
    ...
    /***
     * Representa o cartão de crédito associado a um cliente do Aurora Banking
     * Esta classe herda da classe abstrata Cartao, que contém os atributos e métodos comuns a todos os tipos de cartões.
     */
    
    /**
     * Cria um novo cartão de crédito com os atributos fornecidos.
    ...
    public CartaoCredito(String numero, String nomeImpresso, String validade, String cvv, double limite, Conta conta) {
